...
设计草案；附录 A 记录了已完成的安全修正。产品范围见 [PRD-001](../../product-specs/001-local-encrypted-search.md)，关键取舍见 [ADR-013](../decisions/013-local-encrypted-search-index.md)。

## 概览

本说明定义本地加密搜索的稳定行为和数据保护约束。

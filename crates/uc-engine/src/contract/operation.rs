...
use crate::{
    ...
    AuthenticateMobileRequestInput, BeginMobileFileUploadInput, CustomRelayMutation,
    ExportConfigInput, ExportDiagnosticLogsInput, FinishMobileFileUploadInput,
    MobileContentAvailabilityInput, MobileDeviceInput, MobileLanEndpointUpdate,
    MobileSyncSettingsPatch, PreviewConfigImportInput, ReadMobileSyncFileInput,
    RegisterMobileDeviceInput, RelayCredentialInput, RelayProbeInput,
...
impl fmt::Display for OperationKind {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        let value = match self {
            ...
            Self::QueryProfileRecovery => "query_profile_recovery",
...
impl Operation {
    pub fn kind(&self) -> OperationKind {
        match self {
            ...
            Self::QueryProfileRecovery => OperationKind::QueryProfileRecovery,

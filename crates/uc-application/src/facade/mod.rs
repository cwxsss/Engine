...
pub use space_setup::{
    ...
    IssuePairingInvitationResult, PairingDiagnosticsView, PairingInboundDiagnosticsView,
    PairingInvitationAddressCandidate, PairingInvitationCandidateDiagnostic,
